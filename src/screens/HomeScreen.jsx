...
// import SearchBar from '../components/SearchBar';
// import NavBar from '../components/NavBar'; // Import the bottom nav bar
...
//       {/* Header */}
//       <View className="flex-row items-center justify-between p-4">
//         <Text className="text-2xl font-extrabold text-black">MARKET TRYBE</Text>
//         <TouchableOpacity onPress={() => navigation.navigate('Profile')} className="flex flex-row">
//           <View className="h-12 w-12 items-center justify-center rounded-full bg-gray-300">
//             <FontAwesome name="user" size={30} color="black" />
//           </View>
...
//         {/* ListingCards will scroll under the NavBar */}
//         <ListingCards />
//       </View>
//     </SafeAreaView>
//   );
